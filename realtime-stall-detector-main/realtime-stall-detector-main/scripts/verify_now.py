...
# Sim-only paths — never overwrite the real collected dataset / trained model.
generate_sim_dataset("data/sim_labeled.csv", DEFAULT_SCENARIO, fs=1000, seed=0)
X, y = build_dataset("data/sim_labeled.csv")
model, info = train_model(X, y, seed=0)
save_model(model, "model/sim_tree.joblib")
