...
filename = os.path.dirname(__file__) + '\\data\\sample_data.csv'
...
DOWNSAMPLE = 5   # change to 5–50 depending on density
...
plt.tight_layout()
plt.savefig(os.path.join(os.path.dirname(__file__), 'plots', 'plot.png'))
plt.show()